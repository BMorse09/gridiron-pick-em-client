...
/***/ function(module, exports, __webpack_require__) {
	...
	var onGetLeague = function onGetLeague(data) {
	  event.preventDefault();
	  api.getMatchups(data).done(ui.getLeagueSuccess).fail(ui.failure);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var showLeagueTemplate = __webpack_require__(29);
	...
	var getLeagueSuccess = function getLeagueSuccess(matchups) {
	...
	module.exports = {
	  ...
	  getLeagueSuccess: getLeagueSuccess,
