...
/***/ function(module, exports, __webpack_require__) {
	...
	var onGetMatchups = function onGetMatchups(data) {
	  event.preventDefault();
	  api.getMatchups(data).done(ui.getMatchupsSuccess).fail(ui.failure);
	};

	var onGetMyPicks = function onGetMyPicks() {
	  event.preventDefault();
	  api.getMyPicks().done(ui.getMyPicksSuccess).fail(ui.failure);
	};

	var onSavePicks = function onSavePicks(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  console.log(data);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getMatchups = function getMatchups() {
	  return $.ajax({
	...
	var getMyPicks = function getMyPicks() {
	  return $.ajax({
	...
	var getPrediction = function getPrediction(id) {
	  return $.ajax({
	...
	var getSavePicks = function getSavePicks(data) {
	  return $.ajax({
	    url: app.host + '/predictions',
	    method: "POST",
	    headers: {
	...
	var getUpdatePicks = function getUpdatePicks(data, id) {
	  console.log(data);
	  return $.ajax({
	    url: app.host + '/predictions/' + id,
	    method: "PATCH",
	...
	module.exports = {
	  ...
	  getSavePicks: getSavePicks,
	  getUpdatePicks: getUpdatePicks,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var app = __webpack_require__(7);
	var showMatchupsTemplate = __webpack_require__(9);
	var myPicksListing = __webpack_require__(29);
	var showLeagueTemplate = __webpack_require__(30);
	var editPickListing = __webpack_require__(31);
	var api = __webpack_require__(6);
	var getFormFields = __webpack_require__(5);
	...
	var onUpdatePick = function onUpdatePick(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  // console.log(data);
	  var pickId = $(event.target).find('.updatePickButton').data('id');
	  api.getUpdatePicks(data, pickId).done(updatePickSuccess).fail(failure);
	};

	var onGetPredictionSuccess = function onGetPredictionSuccess(prediction) {
	...
	var onEditPick = function onEditPick(event) {
	  event.preventDefault();
	  var predictionId = $(event.target).data('id');
	  api.getPrediction(predictionId).done(onGetPredictionSuccess).fail(failure);
	};

	var getMyPicksSuccess = function getMyPicksSuccess(predictions) {
	...
	var savePicksSuccess = function savePicksSuccess() {
	  // // console.log(data);
	  //   $('#getSavePicksButton');
	};

	var updatePickSuccess = function updatePickSuccess() {
	  $('.content').html('');
	  api.getMyPicks().done(getMyPicksSuccess).fail(failure);
	};
	...
	module.exports = {
	  ...
	  getMatchupsSuccess: getMatchupsSuccess,
	  // getLeagueSuccess,
	  savePicksSuccess: savePicksSuccess,
	  // getUpdatePickSuccess,
	  getMyPicksSuccess: getMyPicksSuccess
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return "    <td><input type=\"checkbox\" value=\"away\">"
	    ...
	    + "</td>\n    <td>@</td>\n    <td><input type=\"checkbox\" value=\"home\">"
	  ...
	  return "    <td><input type=\"checkbox\" value=\"away\">"
	    ...
	    + "</td>\n    <td>@</td>\n    <td>"
	    + alias4(((helper = (helper = helpers.home || (depth0 != null ? depth0.home : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"home","hash":{},"data":data}) : helper)))
	    + "<input type=\"checkbox\" value=\"home\"></td>\n  </tr>\n";
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return "\n  <div>\n    "
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.matchup : depth0)) != null ? stack1.away : stack1), depth0))
	    + "\n    @\n    "
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.matchup : depth0)) != null ? stack1.home : stack1), depth0))
	    + "\n    :\n    "
	    + alias2(((helper = (helper = helpers.pick || (depth0 != null ? depth0.pick : depth0)) != null ? helper : alias4),(typeof helper === alias5 ? helper.call(alias3,{"name":"pick","hash":{},"data":data}) : helper)))
	    + "\n  </div>\n  <button class=\"btn btn-default edit-pick-button\" data-id="
	  ...
	  return "<h2> Week 4 Matchups</h2>\n<h3> My Picks!</h3>\n\n"
	    + ((stack1 = helpers.each.call(alias1,(depth0 != null ? depth0.predictions : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
	    + "\n\n<!-- <button onclick=\"updatePicks()\">Update Picks</button> -->\n\n<!-- <button onclick=\"load_()\">LOAD</button>  -->\n\n<!--\n<table>\n  <tr>\n"
	    + ((stack1 = helpers.each.call(alias1,(depth0 != null ? depth0.matchups : depth0),{"name":"each","hash":{},"fn":container.program(3, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
	    + "</table> -->\n\n<!-- <table>\n  <tr>\n"
	    + ((stack1 = helpers.each.call(alias1,(depth0 != null ? depth0.matchups : depth0),{"name":"each","hash":{},"fn":container.program(5, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return "<h3> Tickets from Other Members of Your League: </h3>\n\n\n<table>\n  <tr>\n"
	    + ((stack1 = helpers.each.call(alias1,(depth0 != null ? depth0.matchups : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
	    + "</table>\n\n\n<table>\n  <tr>\n"
	    + ((stack1 = helpers.each.call(alias1,(depth0 != null ? depth0.matchups : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
	    + "</table>\n";
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	  ...
	  return "<h1> Edit Pick </h1>\n\n    <div>\n        "
	    + alias2(alias1(((stack1 = ((stack1 = (depth0 != null ? depth0.prediction : depth0)) != null ? stack1.matchup : stack1)) != null ? stack1.away : stack1), depth0))
	    + "\n        @\n        "
	    + alias2(alias1(((stack1 = ((stack1 = (depth0 != null ? depth0.prediction : depth0)) != null ? stack1.matchup : stack1)) != null ? stack1.home : stack1), depth0))
	    + "\n        :\n        "
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.prediction : depth0)) != null ? stack1.pick : stack1), depth0))
	    + "\n\n        <form class='update-pick-form' data-id="
	    ...
	    + ">\n            <br>\n            <input type=\"text\" name=\"prediction[pick]\" value=\"\">\n            <input data-id="
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.prediction : depth0)) != null ? stack1.id : stack1), depth0))
	    + " class=\"updatePickButton\" type=\"submit\" name=\"submit\" value=\"Update my Pick\">\n            <br>\n        </form>\n    </div>\n";
	},"useData":true});
